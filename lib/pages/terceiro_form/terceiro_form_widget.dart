...
import 'terceiro_form_model.dart';
export 'terceiro_form_model.dart';

class TerceiroFormWidget extends StatefulWidget {
  const TerceiroFormWidget({Key? key}) : super(key: key);

  @override
  _TerceiroFormWidgetState createState() => _TerceiroFormWidgetState();
}

class _TerceiroFormWidgetState extends State<TerceiroFormWidget> {
  late TerceiroFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TerceiroFormModel());
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        controller: _model.stateValueController2 ??=
                            FormFieldController<String>(null),
                        options: ['Casa', 'Apartamento', 'Avenida'],
                        onChanged: (val) =>
