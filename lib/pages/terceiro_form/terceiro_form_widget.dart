...
class _TerceiroFormWidgetState extends State<TerceiroFormWidget> {
  ...
  void initState() {
    ...
    _model.yourNameController8 ??= TextEditingController();
    _model.yourNameController9 ??= TextEditingController();
    _model.yourNameController10 ??= TextEditingController();
    _model.yourNameController11 ??= TextEditingController();
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
                    child: TextFormField(
                      controller: _model.yourNameController8,
                      textCapitalization: TextCapitalization.words,
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'UF',
                      ...
                      style: FlutterFlowTheme.of(context).bodyMedium,
                      validator: _model.yourNameController8Validator
                          .asValidator(context),
                    ),
                  ),
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      style: FlutterFlowTheme.of(context).bodyMedium,
                      validator: _model.yourNameController9Validator
                          .asValidator(context),
                    ),
                  ),
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
                    child: TextFormField(
                      controller: _model.yourNameController10,
                      textCapitalization: TextCapitalization.words,
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'UF',
                      ...
                      style: FlutterFlowTheme.of(context).bodyMedium,
                      validator: _model.yourNameController10Validator
                          .asValidator(context),
                    ),
                  ),
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
                    child: TextFormField(
                      controller: _model.yourNameController11,
                      textCapitalization: TextCapitalization.words,
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'UF',
                      ...
                      style: FlutterFlowTheme.of(context).bodyMedium,
                      validator: _model.yourNameController11Validator
                          .asValidator(context),
                    ),
                  ),
                ],
